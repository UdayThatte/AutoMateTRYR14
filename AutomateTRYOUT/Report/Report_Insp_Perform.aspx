<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Report_Insp_Perform.aspx.cs" Inherits="AutomateTRYOUT.Report.Report_Insp_Perform" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="HiddenButton" runat="server" CssClass="hidden" Text="Hidden Button"
     ...
     <%--<asp:UpdatePanel ID="upnlAttendance" runat="server" RenderMode="Inline" UpdateMode="Conditional">--%>
        <ContentTemplate>
     <asp:Panel  ScrollBars="Horizontal" ID="PnlSarchMIS" runat="server" Font-Names="Arial" Font-Size="Small" Style="border: 1px solid #000; margin-left: 0px;"  GroupingText="Insp Performance">
        ...
        <table align="Center" cellpadding="5"  >
            <tr>
             ...
             <tr>
                     ...
                     <%-- <td class="auto-style2">  --%>
                     <td>
                         <asp:TextBox ID="txtInspCode" runat="server" MaxLength="4"></asp:TextBox>
                     </td>
