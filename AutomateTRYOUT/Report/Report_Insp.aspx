<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Report_Insp.aspx.cs" Inherits="AutomateTRYOUT.Report.Report_Insp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="HiddenButton" runat="server" CssClass="hidden" Text="Hidden Button"
     ...
     <%--<asp:UpdatePanel ID="upnlAttendance" runat="server" RenderMode="Inline" UpdateMode="Conditional">--%>
        <ContentTemplate>
     <asp:Panel  ScrollBars="Horizontal" ID="PnlSarchMIS" runat="server" Font-Names="Arial" Font-Size="Small" Style="border: 1px solid #000; margin-left: 0px;"  GroupingText="Inspection Report">
        ...
        <table align="Center" cellpadding="5"  >
         ...
         <asp:Panel  ScrollBars="Horizontal" ID="rptpnlInsp" runat="server" Width="100%" Height="100%" HorizontalAlign="Center" BorderStyle="Solid" BorderWidth="1px">
                <table >
                    <tr>
                       <td> 
                       <%--   <td class="auto-style1"> found followinf solution from web for drop down misplace --%>
                           <div style="margin-left: 10px; position: relative; ">
                            <rsweb:ReportViewer ID="RptInsp" runat="server" AsyncRendering="False" SizeToReportContent="True"
