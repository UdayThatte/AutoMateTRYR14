<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MyReportGetPass.aspx.cs" Inherits="AutomateTRYOUT.Report.ReportGetPass" %>
    ...
    <asp:Button ID="HiddenButton" runat="server" CssClass="hidden" Text="Hidden Button"
     ...
     <asp:ScriptManager ID="ScriptManager2" runat="server" AsyncPostBackTimeout="56000" ></asp:ScriptManager>
       ...
       <%--<asp:UpdatePanel ID="upnlKMPLReport" runat="server" UpdateMode="Conditional" RenderMode="Inline">--%>
        <ContentTemplate>
    <asp:Panel  ScrollBars="Horizontal" ID="PnlSarchPara" runat="server" Font-Names="Arial" Font-Size="Small" Style="border: 1px solid #000;"  GroupingText=" Gate Pass Report" Height="219px">
...
<%--                    <asp:DropDownList ID="ddlFromDay" runat="server"  >
               ...
               <%-- <td>
                ...
                <td>
                     <asp:Label ID="lblConductor" runat="server" Text="Conductor" Font-Size="Medium" Visible="False"></asp:Label>
                </td>
                <td>
                     <asp:DropDownList ID="ddlConductor" runat="server" Width="100%" AppendDataBoundItems="true" Visible="False">
                                 <asp:ListItem Text="ALL" Value="ALL">ALL</asp:ListItem> 
                            </asp:DropDownList>
                </td>
       ...
       <asp:Panel  ScrollBars="Horizontal" ID="rptpnlGetPass" runat="server" Width="100%" Height="100%" HorizontalAlign="Center" Visible="false" BorderStyle="Solid" BorderWidth="1px">
                <table>
                    <tr>
                        <td>
                           <div style="margin-left: 10px; position: relative;">
                            <rsweb:ReportViewer ID="RptGetPass" runat="server" SizeToReportContent="True"
                                
                                Font-Names="Verdana" EnableExternalImages="true" Font-Size="8pt" WaitMessageFont-Size="14pt"
                                InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana" Height="68px" KeepSessionAlive="False" BorderStyle="Solid" BorderWidth="1px" ShowFindControls="False" ShowPrintButton="False" ShowRefreshButton="False" ShowZoomControl="False">
                                <%-- Width="600px"  --%>
                            </rsweb:ReportViewer>
