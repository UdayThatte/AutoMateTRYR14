...
namespace AutomateTRYOUT.Report
{
    public partial class ReportGetPass : System.Web.UI.Page
    {
        ...
        private void BindDataToReport(String reportPath)
        {
            ...
            this.RptGetPass.LocalReport.DisplayName = "GetPass" + "_" + DateTime.Now.ToString("yyyy-MM-dd ");
            ...
            param[8] = new ReportParameter("MachineNo", MachineNo, false);
         
            param[9] = new ReportParameter("StageFrom", FromStage, false);
            param[10] = new ReportParameter("StageTo", ToStage, false);
            param[11] = new ReportParameter("date", date, false);

            param[12] = new ReportParameter("Collection", Collection, false);

            param[13] = new ReportParameter("Expenses", Expenses, false);
            param[14] = new ReportParameter("RFIDUsage", RFIDUsage, false);
            param[15] = new ReportParameter("status", statusnew, false);
