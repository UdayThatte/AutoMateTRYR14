<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Report_Pass_track.aspx.cs" Inherits="AutomateTRYOUT.Report.Report_Pass_track" %>
     ...
     <asp:Panel  ScrollBars="Horizontal" ID="PnlSarchMIS" runat="server" Font-Names="Arial" Font-Size="Small" Style="border: 1px solid #000; margin-left: 0px;"  GroupingText="Pass Tracking">
        ...
        <table align="Center" cellpadding="5"  >
            <tr>
             ...
             <tr>
                     <td>
                     <asp:Label ID="lblPassNo" runat="server" Font-Size="Medium" Text="Pass No" Visible="False"></asp:Label>
                     </td>
                     <%-- <td class="auto-style2">  --%>
                     <td>
                         <asp:TextBox ID="txtPasNo" runat="server" MaxLength="8"></asp:TextBox>
                     </td>
         ...
         <asp:Panel  ScrollBars="Horizontal" ID="rptpnlpasstrack" runat="server" Width="100%" Height="100%" HorizontalAlign="Center" BorderStyle="Solid" BorderWidth="1px">
                <table >
                    <tr>
                       <td> 
                       <%--   <td class="auto-style1"> found followinf solution from web for drop down misplace --%>
                           <div style="margin-left: 10px; position: relative; ">
                            <rsweb:ReportViewer ID="RptPassTrack" runat="server" AsyncRendering="False" SizeToReportContent="True"
