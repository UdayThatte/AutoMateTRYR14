...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="HiddenButton" runat="server" CssClass="hidden" Text="Hidden Button"
     ...
     <%--<asp:UpdatePanel ID="upnlAttendance" runat="server" RenderMode="Inline" UpdateMode="Conditional">--%>
        <ContentTemplate>
     <asp:Panel  ScrollBars="Horizontal" ID="PnlSarchMIS" runat="server" Font-Names="Arial" Font-Size="Small" Style="border: 1px solid #000; margin-left: 0px;"  GroupingText="MIS Report">
        ...
        <table align="Center" cellpadding="5"  >
         ...
         <asp:Panel  ScrollBars="Horizontal" ID="rptpnlMIS" runat="server" Width="100%" Height="100%" HorizontalAlign="Center" BorderStyle="Solid" BorderWidth="1px">
                <table >
                    <tr>
                       <td> 
