<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="True" CodeBehind="ReportTripSheet.aspx.cs" Inherits="AutomateTRYOUT.Report.ReportTripSheet" %>
    ...
    <asp:Button ID="HiddenButton" runat="server" CssClass="hidden" Text="Hidden Button"
     ...
     <asp:ScriptManager ID="ScriptManager2" runat="server" AsyncPostBackTimeout="56000" ></asp:ScriptManager>
       ...
       <%--<asp:UpdatePanel ID="upnlKMPLReport" runat="server" UpdateMode="Conditional" RenderMode="Inline">--%>
        <ContentTemplate>
    <asp:Panel  ScrollBars="Horizontal" ID="PnlSarchPara" runat="server" Font-Names="Arial" Font-Size="Small" Style="border: 1px solid #000;"  GroupingText="Trip Sheet" Height="219px">
                    ...
                    <tr>
                        <td>
                           <div style="margin-left: 10px; position: relative;">
                            <rsweb:ReportViewer ID="RptTripSheet" runat="server" SizeToReportContent="True"
