<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="NewIndex.aspx.cs" Inherits="AutomateTRYOUT.NewIndex" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                ...
                <asp:Panel ScrollBars="Horizontal" ID="pnlIndexNew" runat="server" Height="730px">





                    <asp:Label ID="Label1" runat="server" Font-Size="Medium" Text="Today Issued WayBills- " Font-Bold="True"></asp:Label>
                    <asp:Label ID="lbl_issued_waybills" runat="server" Font-Bold="True" Font-Size="Medium"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label2" runat="server" Font-Size="Medium" Text="Closed WayBills- " Font-Bold="True"></asp:Label>
                    <asp:Label ID="lbl_closed_waybills" runat="server" Font-Bold="True" Font-Size="Medium"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnExport" runat="server" Text="Export Today's Summary" OnClick="btnExport_Click" ></asp:Button>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:GridView ID="GVIndexNew" runat="server" CssClass="pagination-ys" AutoGenerateColumns="False"
                        ...
                        OnPageIndexChanging="GVIndexNew_PageIndexChanging" PageSize="15">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Net Cash">
                                <ItemTemplate>
                                    <asp:Label ID="lblNetCash" runat="server" Text='<%#Eval("NetCash") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Driver Details">
                                <ItemTemplate>
                                    <asp:Label ID="lbldriverdetails" runat="server" Text='<%#Eval("driverdetails") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ScrollBars="Horizontal" ID="PnlMain" runat="server" Style="overflow-x: scroll;">
                    ...
                    <asp:GridView ID="GridView1" runat="server" EmptyDataText="Data not present" Caption="" CellPadding="4" PageSize="1" PagerSettings-Mode="NextPreviousFirstLast"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ExpCnt" DataFormatString="{0:0}" HeaderText="Expenses Count">
                                <ItemStyle HorizontalAlign="Right" Font-Bold="True" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Expenses" DataFormatString="{0:0}" HeaderText="Expenses">
                                <ItemStyle HorizontalAlign="Right" Font-Bold="True" />
                            </asp:BoundField>
                            <asp:BoundField DataField="RFIDCardCnt" DataFormatString="{0:0}" HeaderText="RFID Cards">
                                <ItemStyle HorizontalAlign="Right" Font-Bold="True" />
                            </asp:BoundField>
                            <asp:BoundField DataField="RfidPaxCnt" DataFormatString="{0:0}" HeaderText="RFID Pax">
                                <ItemStyle HorizontalAlign="Right" Font-Bold="True" />
                            </asp:BoundField>
                            <asp:BoundField DataField="RFIDAmt" DataFormatString="{0:0}" HeaderText="RFID Amt">
                                <ItemStyle HorizontalAlign="Right" Font-Bold="True" />
                            </asp:BoundField>
                            <asp:BoundField DataField="NetCash" DataFormatString="{0:0}" HeaderText="Net Cash">
                                <ItemStyle HorizontalAlign="Right" Font-Bold="True" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="PntyCnt" DataFormatString="{0:0}" HeaderText="Penalty Count">
                                <ItemStyle HorizontalAlign="Right" Font-Bold="True" />
                            </asp:BoundField>
             ...
             <asp:Panel ID="dummypanelforexport" runat ="server" Height="730px" >
                 <asp:GridView ID="HiddenGrid" runat="server" CellPadding="4" GridLines="None" Width="100%" 
                        PageSize="500" Visible="False" AutoGenerateColumns="False">
                        <%--  ForeColor="#333333" CssClass ="pagination-ys"> --%>
                        <%--  <PagerStyle CssClass="pagination-ys" /> --%>
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Date">
                                <ItemTemplate>
                                    <asp:Label ID="lblwbp_date" runat="server" Text='<%#Eval("IssueDate") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="vehical No">
                                <ItemTemplate>
                                    <asp:Label ID="lblvehicalno" runat="server" Text='<%#Eval("VehicleNo") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Driver Details">
                                <ItemTemplate>
                                    <asp:Label ID="lbldriverdetails" runat="server" Text='<%#Eval("Driver") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
