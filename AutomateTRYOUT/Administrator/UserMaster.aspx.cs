...
namespace AutomateTRYOUT.Administrator
{
    public partial class UserMaster : System.Web.UI.Page
    {
        ...
        private void bindGridView()
        {
            ...
            if (Session["RoleName"].ToString() == "NormalUser")
            {
                gvUserMaster.Columns[0].Visible = false; //uday
                gvUserMaster.Columns[1].Visible = false;
            }
        }
        ...
        protected void gvUserMaster_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            int returnval;
            if (gvUserMaster.Rows.Count ==1)
                        return; //if only single user then dont delete
