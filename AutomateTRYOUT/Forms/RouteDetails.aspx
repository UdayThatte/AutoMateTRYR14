<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"  CodeBehind="RouteDetails.aspx.cs" Inherits="AutomateTRYOUT.Forms.RouteMasterNew" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="plnRouteDetails" runat="server" >
 ...
 <asp:TextBox ID="txtFromDateTime" runat="server"></asp:TextBox>
   ...
   <tr>
    ...
    <asp:Panel ID="pnlgvRouteDetails" runat="server">
                <asp:GridView ID="gvRouteMasterr" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                  >
                    <Columns>
