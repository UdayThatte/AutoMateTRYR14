...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ScrollBars="Horizontal" ID="pnlgvRouteMaster" runat="server">
        <h1>Route Master</h1>
        <span onclick="return confirm('Are you Sure to Delete ALL Routes?')">
        <asp:Button ID="btnDeleteAll" runat="server" Text="Delete ALL Routes" OnClick="btnDeleteAll_Click" Font-Bold="true" Font-Size="Small" Visible="true" />
        </span>
        <asp:GridView ID="gvRouteMasterr" runat="server" CssClass="pagination-ys" AutoGenerateColumns="False"
            ...
            OnRowDeleting="gvRouteMaster_RowDeleting">
            <AlternatingRowStyle BackColor="White" />
            <PagerStyle CssClass="pagination-ys" />
            <Columns>
                <asp:TemplateField HeaderText="Delete" >
                    <ItemTemplate>
                        <span onclick="return confirm('Are you SURE to DELETE this Route?')">
                ...
                <asp:TemplateField HeaderText="Local Name" visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblrp_stgmarathiname" runat="server" Text='<%#Eval("rp_stgmarathiname") %>'></asp:Label>
                    </ItemTemplate>

                </asp:TemplateField>
                <asp:TemplateField HeaderText="Fare Changed" Visible = "false">
                    <ItemTemplate>
