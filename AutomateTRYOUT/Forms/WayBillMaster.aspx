<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
     CodeBehind="WayBillMaster.aspx.cs" Inherits="AutomateTRYOUT.Forms.WayBillMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="plnSearchWayBillMaster" runat="server" >
 ...
 <asp:TextBox ID="txtFromDateTime" runat="server"></asp:TextBox>
   ...
   <tr>
    ...
    <asp:Panel ID="pnlgvWayBillMaster" runat="server">
                <asp:GridView ID="gvWayBillMaster" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                  >
                    <Columns>
