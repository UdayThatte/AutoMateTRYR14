<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepoMaster.aspx.cs" Inherits="AutomateTRYOUT.Forms.DepoMaster" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

     <asp:Panel ID="plnDepoMaster" runat="server" >
 ...
 <asp:TextBox ID="txtFromDateTime" runat="server"></asp:TextBox>
   ...
   <tr>
    ...
    <asp:Panel ID="pnlgvDepoMaster" runat="server">
