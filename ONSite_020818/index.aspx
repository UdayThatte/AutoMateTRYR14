<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs"
     Inherits="AutomateTRYOUT.index" %>
        ...
        <table align="Center" cellpadding="5">
            ...
            <tr>
             ...
             <td>
               ...
               <asp:Button ID="BtnRefresh"  runat="server" Width="70px"  Text="Refresh" OnClick="BtnRefresh_Click"  />
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="text-center m-t-lg">
                ...
                <asp:Panel  ScrollBars="Horizontal"  ID="pnlHeader" runat="server" Visible="true" >
